  ...
  return (
    <div className='text-gray-800'>
        <div>
            ...
            <Button>Nos Realisation <span> <FontAwesomeIcon icon={faArrowRight}/> </span> </Button>
            <p className='py-4'>
            ...
            <div className='flex gap-8'>
                <Button>Notre Blog <span><FontAwesomeIcon icon={faArrowRight}/></span> </Button>
                <Button>Nos evenements <span><FontAwesomeIcon icon={faArrowRight}/></span> </Button>
            </div>
            ...
            <Button>Decouvrez nos services <span><FontAwesomeIcon icon={faArrowRight}/></span> </Button>
            <h2 className='font-bold'>
